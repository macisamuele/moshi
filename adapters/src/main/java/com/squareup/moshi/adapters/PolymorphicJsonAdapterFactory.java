...
public final class PolymorphicJsonAdapterFactory<T> implements JsonAdapter.Factory {
  ...
  @Nullable final JsonAdapter<T> fallbackJsonAdapter;
  ...
  PolymorphicJsonAdapterFactory(
      ...
      @Nullable JsonAdapter<T> fallbackJsonAdapter) {
  ...
  private JsonAdapter<T> buildFallbackJsonAdapter(final T defaultValue) {
    return new DefaultJsonAdapter<T>() {
      @Nullable
      @Override
